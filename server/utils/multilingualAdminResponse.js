...
const ERROR_CODES = {
  ...
  AI_TRANSLATION_CANCELLED: 'AI_TRANSLATION_CANCELLED',
  TRANSLATION_JOB_ID_INVALID: 'TRANSLATION_JOB_ID_INVALID',
  TRANSLATION_JOB_NOT_FOUND: 'TRANSLATION_JOB_NOT_FOUND',
  TRANSLATION_JOB_FIELD_INVALID: 'TRANSLATION_JOB_FIELD_INVALID',
  TRANSLATION_JOB_STATUS_INVALID: 'TRANSLATION_JOB_STATUS_INVALID',
  TRANSLATION_JOB_ACTION_FORBIDDEN: 'TRANSLATION_JOB_ACTION_FORBIDDEN',
...
const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.AI_TRANSLATION_CANCELLED]: 'AI 翻译已停止',
  [ERROR_CODES.TRANSLATION_JOB_ID_INVALID]: '后台翻译任务 ID 格式错误',
  [ERROR_CODES.TRANSLATION_JOB_NOT_FOUND]: '后台翻译任务不存在',
  [ERROR_CODES.TRANSLATION_JOB_FIELD_INVALID]: '后台翻译任务字段校验失败',
  [ERROR_CODES.TRANSLATION_JOB_STATUS_INVALID]: '后台翻译任务状态不支持',
