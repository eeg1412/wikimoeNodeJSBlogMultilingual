...
const multilingualAdminRouteSetting = [
  ...
  {
    path: '/source/post/ai-import-cover-translate',
    method: 'post',
    middleware: [checkAuth],
    controller: require('../api/multilingual-admin/source/post/translateAiImportCoverImages')
  },
  {
  ...
  {
    path: '/source/relation/refresh-snapshot',
    method: 'post',
    middleware: [checkAuth],
    controller: require('../api/multilingual-admin/source/relation/refreshSnapshot')
  },
  {
  ...
  },
  {
    ...
    method: 'put',
    middleware: [checkAuth],
    controller: require('../api/multilingual-admin/translation/post/updateStatus')
  },
  {
