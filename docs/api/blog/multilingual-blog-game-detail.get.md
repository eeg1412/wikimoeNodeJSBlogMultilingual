# GET /api/multilingual-blog/game/detail

## 概述

- 接口类型：多语言 Blog API
- 说明：获取游戏详情。
- 访问路径：`/api/multilingual-blog/game/detail`
- 上游路径：同访问路径
- 控制器：`server/api/blog/game/getGameDetail.js`
- 前端封装：`blog/app/api/game.js#getGameDetailApi`

## 请求

- Method：`GET`
- URL：`/api/multilingual-blog/game/detail`
