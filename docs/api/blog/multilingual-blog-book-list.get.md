# GET /api/multilingual-blog/book/list

## 概述

- 接口类型：多语言 Blog API
- 说明：分页获取书籍列表。
- 访问路径：`/api/multilingual-blog/book/list`
- 上游路径：同访问路径
- 控制器：`server/api/blog/book/getBookList.js`
- 前端封装：`blog/app/api/book.js#getBookListApi`

## 请求

- Method：`GET`
- URL：`/api/multilingual-blog/book/list`
...
| `booktypeId` | Query | ObjectId | 否 | 书籍类型 ID。 |
