# GET /api/multilingual-blog/bangumi/detail

## 概述

- 接口类型：多语言 Blog API
- 说明：获取番剧详情。
- 访问路径：`/api/multilingual-blog/bangumi/detail`
- 上游路径：同访问路径
- 控制器：`server/api/blog/bangumi/getBangumiDetail.js`
- 前端封装：`blog/app/api/bangumi.js#getBangumiDetailApi`

## 请求

- Method：`GET`
- URL：`/api/multilingual-blog/bangumi/detail`
