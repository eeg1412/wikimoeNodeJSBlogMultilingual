# GET /api/multilingual-blog/booktype/list

## 概述

- 接口类型：多语言 Blog API
- 说明：获取书籍类型列表。
- 访问路径：`/api/multilingual-blog/booktype/list`
- 上游路径：同访问路径
- 控制器：`server/api/blog/book/getBooktypeList.js`
- 前端封装：`blog/app/api/book.js#getBooktypeListApi`

## 请求

- Method：`GET`
- URL：`/api/multilingual-blog/booktype/list`
